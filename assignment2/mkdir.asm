...
main(int argc, char *argv[])
{
  ...
  47:	e8 b4 03 00 00       	call   400 <mkdir>
...
strtok(char *teststr, char ch)
{
 ...
 308:	eb 75                	jmp    37f <strtok+0xae>
    ...
    {
        if(*nexttok == '\0')
 30a:	a1 94 0b 00 00       	mov    0xb94,%eax
 ...
 31a:	eb 6f                	jmp    38b <strtok+0xba>
        dummystr = nexttok;
 31c:	a1 94 0b 00 00       	mov    0xb94,%eax
 ...
 354:	a3 94 0b 00 00       	mov    %eax,0xb94
                break;
 ...
 36a:	40                   	inc    %eax
 36b:	a3 94 0b 00 00       	mov    %eax,0xb94
                *end = *address_of_null;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b6:	8a 80 80 0b 00 00    	mov    0xb80(%eax),%al
...
free(void *ap)
{
 ...
 6df:	a1 a0 0b 00 00       	mov    0xba0,%eax
...
free(void *ap)
{
 ...
 7aa:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 7af:	c9                   	leave  
 7b0:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7fd:	e8 ce fe ff ff       	call   6d0 <free>
  return freep;
 802:	a1 a0 0b 00 00       	mov    0xba0,%eax
}
 807:	c9                   	leave  
 808:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 819:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 81c:	a1 a0 0b 00 00       	mov    0xba0,%eax
 821:	89 45 f0             	mov    %eax,-0x10(%ebp)
 824:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 828:	75 23                	jne    84d <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 82a:	c7 45 f0 98 0b 00 00 	movl   $0xb98,-0x10(%ebp)
 831:	8b 45 f0             	mov    -0x10(%ebp),%eax
 834:	a3 a0 0b 00 00       	mov    %eax,0xba0
 839:	a1 a0 0b 00 00       	mov    0xba0,%eax
 83e:	a3 98 0b 00 00       	mov    %eax,0xb98
    base.s.size = 0;
 843:	c7 05 9c 0b 00 00 00 	movl   $0x0,0xb9c
 84a:	00 00 00 
  }
 ...
 8a0:	a3 a0 0b 00 00       	mov    %eax,0xba0
      return (void*)(p + 1);
 ...
 8ab:	eb 38                	jmp    8e5 <malloc+0xdc>
    ...
    if(p == freep)
 8ad:	a1 a0 0b 00 00       	mov    0xba0,%eax
