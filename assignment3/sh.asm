...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    101b:	8b 04 85 e4 24 00 00 	mov    0x24e4(,%eax,4),%eax
    1022:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
    1024:	c7 04 24 b8 24 00 00 	movl   $0x24b8,(%esp)
  ...
  case EXEC:
    ...
    1067:	c7 44 24 04 bf 24 00 	movl   $0x24bf,0x4(%esp)
    106e:	00 
    106f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1076:	e8 6e 10 00 00       	call   20e9 <printf>
    break;
  ...
  case REDIR:
    ...
    10ba:	c7 44 24 04 cf 24 00 	movl   $0x24cf,0x4(%esp)
    10c1:	00 
    10c2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    10c9:	e8 1b 10 00 00       	call   20e9 <printf>
      exit();
  ...
  case PIPE:
    ...
    112e:	79 0c                	jns    113c <runcmd+0x13c>
      panic("pipe");
    1130:	c7 04 24 df 24 00 00 	movl   $0x24df,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
    1211:	c7 44 24 04 fc 24 00 	movl   $0x24fc,0x4(%esp)
    1218:	00 
    1219:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1220:	e8 c4 0e 00 00       	call   20e9 <printf>
  memset(buf, 0, nbuf);
    ...
    1287:	eb 1f                	jmp    12a8 <main+0x3f>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    1290:	00 
    1291:	c7 04 24 ff 24 00 00 	movl   $0x24ff,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    12fb:	00 
    12fc:	c7 44 24 04 07 25 00 	movl   $0x2507,0x4(%esp)
    1303:	00 
    1304:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    130b:	e8 d9 0d 00 00       	call   20e9 <printf>
      continue;
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
    ...
    1364:	c7 44 24 04 15 25 00 	movl   $0x2515,0x4(%esp)
    136b:	00 
    136c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1373:	e8 71 0d 00 00       	call   20e9 <printf>
  exit();
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
    1391:	c7 04 24 19 25 00 00 	movl   $0x2519,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    13af:	e8 21 10 00 00       	call   23d5 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    13ed:	e8 e3 0f 00 00       	call   23d5 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    1458:	e8 78 0f 00 00       	call   23d5 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    14a8:	e8 28 0f 00 00       	call   23d5 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    14f8:	e8 d8 0e 00 00       	call   23d5 <malloc>
    ...
    1542:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    155b:	c7 04 24 30 3a 00 00 	movl   $0x3a30,(%esp)
  ...
  default:
    ...
    1605:	c7 04 24 30 3a 00 00 	movl   $0x3a30,(%esp)
    ...
    1622:	c7 04 24 36 3a 00 00 	movl   $0x3a36,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    1660:	c7 04 24 30 3a 00 00 	movl   $0x3a30,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    16a6:	c7 04 24 30 3a 00 00 	movl   $0x3a30,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
    1721:	c7 44 24 08 1e 25 00 	movl   $0x251e,0x8(%esp)
    1728:	00 
  ...
  if(s != es){
    ...
    174a:	c7 44 24 04 1f 25 00 	movl   $0x251f,0x4(%esp)
    1751:	00 
    1752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1759:	e8 8b 09 00 00       	call   20e9 <printf>
    panic("syntax");
    175e:	c7 04 24 2e 25 00 00 	movl   $0x252e,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
    17cb:	c7 44 24 08 35 25 00 	movl   $0x2535,0x8(%esp)
    17d2:	00 
  ...
  if(peek(ps, es, ";")){
    17e9:	c7 44 24 08 37 25 00 	movl   $0x2537,0x8(%esp)
    17f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
    186d:	c7 44 24 08 39 25 00 	movl   $0x2539,0x8(%esp)
    1874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    192b:	c7 04 24 3b 25 00 00 	movl   $0x253b,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    19d7:	c7 44 24 08 58 25 00 	movl   $0x2558,0x8(%esp)
    19de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    1a04:	c7 44 24 08 5b 25 00 	movl   $0x255b,0x8(%esp)
    1a0b:	00 
    ...
    panic("parseblock");
    1a22:	c7 04 24 5d 25 00 00 	movl   $0x255d,(%esp)
  ...
  if(!peek(ps, es, ")"))
    1a65:	c7 44 24 08 68 25 00 	movl   $0x2568,0x8(%esp)
    1a6c:	00 
    ...
    1a83:	c7 04 24 6a 25 00 00 	movl   $0x256a,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
    1ad8:	c7 44 24 08 5b 25 00 	movl   $0x255b,0x8(%esp)
    1adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    1b75:	74 0c                	je     1b83 <parseexec+0xb1>
      panic("syntax");
    1b77:	c7 04 24 2e 25 00 00 	movl   $0x252e,(%esp)
    ...
    1ba8:	7e 0c                	jle    1bb6 <parseexec+0xe4>
      panic("too many args");
    1baa:	c7 04 24 7d 25 00 00 	movl   $0x257d,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
    1bd2:	c7 44 24 08 8b 25 00 	movl   $0x258b,0x8(%esp)
    1bd9:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    1c3c:	8b 04 85 90 25 00 00 	mov    0x2590(,%eax,4),%eax
    1c43:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
putc(int fd, char c)
{
    ...
    200c:	83 ec 18             	sub    $0x18,%esp
    200f:	8b 45 0c             	mov    0xc(%ebp),%eax
    2012:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    2015:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    201c:	00 
    201d:	8d 45 f4             	lea    -0xc(%ebp),%eax
    2020:	89 44 24 04          	mov    %eax,0x4(%esp)
    2024:	8b 45 08             	mov    0x8(%ebp),%eax
    2027:	89 04 24             	mov    %eax,(%esp)
    202a:	e8 52 ff ff ff       	call   1f81 <write>
}
    202f:	c9                   	leave  
    2030:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    2039:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    2040:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    2044:	74 17                	je     205d <printint+0x2c>
    2046:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    204a:	79 11                	jns    205d <printint+0x2c>
    neg = 1;
    204c:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    2053:	8b 45 0c             	mov    0xc(%ebp),%eax
    2056:	f7 d8                	neg    %eax
    2058:	89 45 ec             	mov    %eax,-0x14(%ebp)
    205b:	eb 06                	jmp    2063 <printint+0x32>
  } else {
    x = xx;
    205d:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  do{
    buf[i++] = digits[x % base];
    206a:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    206d:	8d 41 01             	lea    0x1(%ecx),%eax
    2070:	89 45 f4             	mov    %eax,-0xc(%ebp)
    2073:	8b 5d 10             	mov    0x10(%ebp),%ebx
    2076:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2079:	ba 00 00 00 00       	mov    $0x0,%edx
    207e:	f7 f3                	div    %ebx
    2080:	89 d0                	mov    %edx,%eax
    2082:	0f b6 80 3e 3a 00 00 	movzbl 0x3a3e(%eax),%eax
    2089:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    208d:	8b 75 10             	mov    0x10(%ebp),%esi
    2090:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2093:	ba 00 00 00 00       	mov    $0x0,%edx
    2098:	f7 f6                	div    %esi
    209a:	89 45 ec             	mov    %eax,-0x14(%ebp)
    209d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    20a1:	75 c7                	jne    206a <printint+0x39>
  if(neg)
    20a3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    20a7:	74 10                	je     20b9 <printint+0x88>
    buf[i++] = '-';
    20a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20ac:	8d 50 01             	lea    0x1(%eax),%edx
    20af:	89 55 f4             	mov    %edx,-0xc(%ebp)
    20b2:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    20b7:	eb 1f                	jmp    20d8 <printint+0xa7>
    20b9:	eb 1d                	jmp    20d8 <printint+0xa7>
    putc(fd, buf[i]);
    20bb:	8d 55 dc             	lea    -0x24(%ebp),%edx
    20be:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20c1:	01 d0                	add    %edx,%eax
    20c3:	0f b6 00             	movzbl (%eax),%eax
    20c6:	0f be c0             	movsbl %al,%eax
    20c9:	89 44 24 04          	mov    %eax,0x4(%esp)
    20cd:	8b 45 08             	mov    0x8(%ebp),%eax
    20d0:	89 04 24             	mov    %eax,(%esp)
    20d3:	e8 31 ff ff ff       	call   2009 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    20d8:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    20dc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    20e0:	79 d9                	jns    20bb <printint+0x8a>
    putc(fd, buf[i]);
}
...
printf(int fd, char *fmt, ...)
{
    ...
    20ec:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    20ef:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    20f6:	8d 45 0c             	lea    0xc(%ebp),%eax
    20f9:	83 c0 04             	add    $0x4,%eax
    20fc:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    20ff:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    2106:	e9 7c 01 00 00       	jmp    2287 <printf+0x19e>
    c = fmt[i] & 0xff;
    210b:	8b 55 0c             	mov    0xc(%ebp),%edx
    210e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2111:	01 d0                	add    %edx,%eax
    2113:	0f b6 00             	movzbl (%eax),%eax
    2116:	0f be c0             	movsbl %al,%eax
    2119:	25 ff 00 00 00       	and    $0xff,%eax
    211e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    2121:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    2125:	75 2c                	jne    2153 <printf+0x6a>
      if(c == '%'){
    2127:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    212b:	75 0c                	jne    2139 <printf+0x50>
        state = '%';
    212d:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    2134:	e9 4a 01 00 00       	jmp    2283 <printf+0x19a>
      } else {
        putc(fd, c);
    2139:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    213c:	0f be c0             	movsbl %al,%eax
    213f:	89 44 24 04          	mov    %eax,0x4(%esp)
    2143:	8b 45 08             	mov    0x8(%ebp),%eax
    2146:	89 04 24             	mov    %eax,(%esp)
    2149:	e8 bb fe ff ff       	call   2009 <putc>
    214e:	e9 30 01 00 00       	jmp    2283 <printf+0x19a>
      }
    } else if(state == '%'){
    2153:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    2157:	0f 85 26 01 00 00    	jne    2283 <printf+0x19a>
      if(c == 'd'){
    215d:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    2161:	75 2d                	jne    2190 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    2163:	8b 45 e8             	mov    -0x18(%ebp),%eax
    2166:	8b 00                	mov    (%eax),%eax
    2168:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    216f:	00 
    2170:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    2177:	00 
    2178:	89 44 24 04          	mov    %eax,0x4(%esp)
    217c:	8b 45 08             	mov    0x8(%ebp),%eax
    217f:	89 04 24             	mov    %eax,(%esp)
    2182:	e8 aa fe ff ff       	call   2031 <printint>
        ap++;
    2187:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    218b:	e9 ec 00 00 00       	jmp    227c <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    2190:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    2194:	74 06                	je     219c <printf+0xb3>
    2196:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    219a:	75 2d                	jne    21c9 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    219c:	8b 45 e8             	mov    -0x18(%ebp),%eax
    219f:	8b 00                	mov    (%eax),%eax
    21a1:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    21a8:	00 
    21a9:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    21b0:	00 
    21b1:	89 44 24 04          	mov    %eax,0x4(%esp)
    21b5:	8b 45 08             	mov    0x8(%ebp),%eax
    21b8:	89 04 24             	mov    %eax,(%esp)
    21bb:	e8 71 fe ff ff       	call   2031 <printint>
        ap++;
    21c0:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    21c4:	e9 b3 00 00 00       	jmp    227c <printf+0x193>
      } else if(c == 's'){
    21c9:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    21cd:	75 45                	jne    2214 <printf+0x12b>
        s = (char*)*ap;
    21cf:	8b 45 e8             	mov    -0x18(%ebp),%eax
    21d2:	8b 00                	mov    (%eax),%eax
    21d4:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    21d7:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    21db:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    21df:	75 09                	jne    21ea <printf+0x101>
          s = "(null)";
    21e1:	c7 45 f4 a8 25 00 00 	movl   $0x25a8,-0xc(%ebp)
        while(*s != 0){
    21e8:	eb 1e                	jmp    2208 <printf+0x11f>
    21ea:	eb 1c                	jmp    2208 <printf+0x11f>
          putc(fd, *s);
    21ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
    21ef:	0f b6 00             	movzbl (%eax),%eax
    21f2:	0f be c0             	movsbl %al,%eax
    21f5:	89 44 24 04          	mov    %eax,0x4(%esp)
    21f9:	8b 45 08             	mov    0x8(%ebp),%eax
    21fc:	89 04 24             	mov    %eax,(%esp)
    21ff:	e8 05 fe ff ff       	call   2009 <putc>
          s++;
    2204:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    2210:	75 da                	jne    21ec <printf+0x103>
    2212:	eb 68                	jmp    227c <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    2214:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    2218:	75 1d                	jne    2237 <printf+0x14e>
        putc(fd, *ap);
    221a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    221d:	8b 00                	mov    (%eax),%eax
    221f:	0f be c0             	movsbl %al,%eax
    2222:	89 44 24 04          	mov    %eax,0x4(%esp)
    2226:	8b 45 08             	mov    0x8(%ebp),%eax
    2229:	89 04 24             	mov    %eax,(%esp)
    222c:	e8 d8 fd ff ff       	call   2009 <putc>
        ap++;
    2231:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    2235:	eb 45                	jmp    227c <printf+0x193>
      } else if(c == '%'){
    2237:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    223b:	75 17                	jne    2254 <printf+0x16b>
        putc(fd, c);
    223d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2240:	0f be c0             	movsbl %al,%eax
    2243:	89 44 24 04          	mov    %eax,0x4(%esp)
    2247:	8b 45 08             	mov    0x8(%ebp),%eax
    224a:	89 04 24             	mov    %eax,(%esp)
    224d:	e8 b7 fd ff ff       	call   2009 <putc>
    2252:	eb 28                	jmp    227c <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    2254:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    225b:	00 
    225c:	8b 45 08             	mov    0x8(%ebp),%eax
    225f:	89 04 24             	mov    %eax,(%esp)
    2262:	e8 a2 fd ff ff       	call   2009 <putc>
        putc(fd, c);
    2267:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    226a:	0f be c0             	movsbl %al,%eax
    226d:	89 44 24 04          	mov    %eax,0x4(%esp)
    2271:	8b 45 08             	mov    0x8(%ebp),%eax
    2274:	89 04 24             	mov    %eax,(%esp)
    2277:	e8 8d fd ff ff       	call   2009 <putc>
      }
      state = 0;
    227c:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    2283:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    2287:	8b 55 0c             	mov    0xc(%ebp),%edx
    228a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    228d:	01 d0                	add    %edx,%eax
    228f:	0f b6 00             	movzbl (%eax),%eax
    2292:	84 c0                	test   %al,%al
    2294:	0f 85 71 fe ff ff    	jne    210b <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    229f:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    22a2:	8b 45 08             	mov    0x8(%ebp),%eax
    22a5:	83 e8 08             	sub    $0x8,%eax
    22a8:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    22ab:	a1 cc 3a 00 00       	mov    0x3acc,%eax
    22b0:	89 45 fc             	mov    %eax,-0x4(%ebp)
    22b3:	eb 24                	jmp    22d9 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    22b5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    22b8:	8b 00                	mov    (%eax),%eax
    22ba:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    22bd:	77 12                	ja     22d1 <free+0x35>
    22bf:	8b 45 f8             	mov    -0x8(%ebp),%eax
    22c2:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    22c5:	77 24                	ja     22eb <free+0x4f>
    22c7:	8b 45 fc             	mov    -0x4(%ebp),%eax
    22ca:	8b 00                	mov    (%eax),%eax
    22cc:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    22cf:	77 1a                	ja     22eb <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    22d6:	89 45 fc             	mov    %eax,-0x4(%ebp)
    22d9:	8b 45 f8             	mov    -0x8(%ebp),%eax
    22dc:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    22df:	76 d4                	jbe    22b5 <free+0x19>
    22e1:	8b 45 fc             	mov    -0x4(%ebp),%eax
    22e4:	8b 00                	mov    (%eax),%eax
    22e6:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    22e9:	76 ca                	jbe    22b5 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    22eb:	8b 45 f8             	mov    -0x8(%ebp),%eax
    22ee:	8b 40 04             	mov    0x4(%eax),%eax
    22f1:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    22f8:	8b 45 f8             	mov    -0x8(%ebp),%eax
    22fb:	01 c2                	add    %eax,%edx
    22fd:	8b 45 fc             	mov    -0x4(%ebp),%eax
    2300:	8b 00                	mov    (%eax),%eax
    2302:	39 c2                	cmp    %eax,%edx
    2304:	75 24                	jne    232a <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    2306:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2309:	8b 50 04             	mov    0x4(%eax),%edx
    230c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    230f:	8b 00                	mov    (%eax),%eax
    2311:	8b 40 04             	mov    0x4(%eax),%eax
    2314:	01 c2                	add    %eax,%edx
    2316:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2319:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    231c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    231f:	8b 00                	mov    (%eax),%eax
    2321:	8b 10                	mov    (%eax),%edx
    2323:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2326:	89 10                	mov    %edx,(%eax)
    2328:	eb 0a                	jmp    2334 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    232a:	8b 45 fc             	mov    -0x4(%ebp),%eax
  ...
  if(p + p->s.size == bp){
    ...
    233a:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    2341:	8b 45 fc             	mov    -0x4(%ebp),%eax
    2344:	01 d0                	add    %edx,%eax
    2346:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    2349:	75 20                	jne    236b <free+0xcf>
    p->s.size += bp->s.size;
    234b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    234e:	8b 50 04             	mov    0x4(%eax),%edx
    2351:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2354:	8b 40 04             	mov    0x4(%eax),%eax
    2357:	01 c2                	add    %eax,%edx
    2359:	8b 45 fc             	mov    -0x4(%ebp),%eax
    235c:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    235f:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2362:	8b 10                	mov    (%eax),%edx
    2364:	8b 45 fc             	mov    -0x4(%ebp),%eax
    2367:	89 10                	mov    %edx,(%eax)
    2369:	eb 08                	jmp    2373 <free+0xd7>
  } else
    p->s.ptr = bp;
    236b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    236e:	8b 55 f8             	mov    -0x8(%ebp),%edx
    2371:	89 10                	mov    %edx,(%eax)
  freep = p;
    2373:	8b 45 fc             	mov    -0x4(%ebp),%eax
    2376:	a3 cc 3a 00 00       	mov    %eax,0x3acc
}
    237b:	c9                   	leave  
    237c:	c3                   	ret    
...
{
    237d:	55                   	push   %ebp
    237e:	89 e5                	mov    %esp,%ebp
    2380:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    2383:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    238a:	77 07                	ja     2393 <morecore+0x16>
    nu = 4096;
    238c:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    2393:	8b 45 08             	mov    0x8(%ebp),%eax
    2396:	c1 e0 03             	shl    $0x3,%eax
    2399:	89 04 24             	mov    %eax,(%esp)
    239c:	e8 48 fc ff ff       	call   1fe9 <sbrk>
    23a1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    23a4:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    23a8:	75 07                	jne    23b1 <morecore+0x34>
    return 0;
    23aa:	b8 00 00 00 00       	mov    $0x0,%eax
    23af:	eb 22                	jmp    23d3 <morecore+0x56>
  hp = (Header*)p;
    23b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    23b4:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    23b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
    23ba:	8b 55 08             	mov    0x8(%ebp),%edx
    23bd:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    23c0:	8b 45 f0             	mov    -0x10(%ebp),%eax
    23c3:	83 c0 08             	add    $0x8,%eax
    23c6:	89 04 24             	mov    %eax,(%esp)
    23c9:	e8 ce fe ff ff       	call   229c <free>
  return freep;
    23ce:	a1 cc 3a 00 00       	mov    0x3acc,%eax
}
    23d3:	c9                   	leave  
    23d4:	c3                   	ret    
...
{
    23d5:	55                   	push   %ebp
    23d6:	89 e5                	mov    %esp,%ebp
    23d8:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    23db:	8b 45 08             	mov    0x8(%ebp),%eax
    23de:	83 c0 07             	add    $0x7,%eax
    23e1:	c1 e8 03             	shr    $0x3,%eax
    23e4:	83 c0 01             	add    $0x1,%eax
    23e7:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    23ea:	a1 cc 3a 00 00       	mov    0x3acc,%eax
    23ef:	89 45 f0             	mov    %eax,-0x10(%ebp)
    23f2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    23f6:	75 23                	jne    241b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    23f8:	c7 45 f0 c4 3a 00 00 	movl   $0x3ac4,-0x10(%ebp)
    23ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2402:	a3 cc 3a 00 00       	mov    %eax,0x3acc
    2407:	a1 cc 3a 00 00       	mov    0x3acc,%eax
    240c:	a3 c4 3a 00 00       	mov    %eax,0x3ac4
    base.s.size = 0;
    2411:	c7 05 c8 3a 00 00 00 	movl   $0x0,0x3ac8
    2418:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    241b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    241e:	8b 00                	mov    (%eax),%eax
    2420:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    2423:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2426:	8b 40 04             	mov    0x4(%eax),%eax
    2429:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    242c:	72 4d                	jb     247b <malloc+0xa6>
      if(p->s.size == nunits)
    242e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2431:	8b 40 04             	mov    0x4(%eax),%eax
    2434:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    2437:	75 0c                	jne    2445 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    2439:	8b 45 f4             	mov    -0xc(%ebp),%eax
    243c:	8b 10                	mov    (%eax),%edx
    243e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2441:	89 10                	mov    %edx,(%eax)
    2443:	eb 26                	jmp    246b <malloc+0x96>
      else {
        p->s.size -= nunits;
    2445:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2448:	8b 40 04             	mov    0x4(%eax),%eax
    244b:	2b 45 ec             	sub    -0x14(%ebp),%eax
    244e:	89 c2                	mov    %eax,%edx
    2450:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2453:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    2456:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2459:	8b 40 04             	mov    0x4(%eax),%eax
    245c:	c1 e0 03             	shl    $0x3,%eax
    245f:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    2462:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2465:	8b 55 ec             	mov    -0x14(%ebp),%edx
    2468:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    246b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    246e:	a3 cc 3a 00 00       	mov    %eax,0x3acc
      return (void*)(p + 1);
    2473:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2476:	83 c0 08             	add    $0x8,%eax
    2479:	eb 38                	jmp    24b3 <malloc+0xde>
    }
    if(p == freep)
    247b:	a1 cc 3a 00 00       	mov    0x3acc,%eax
    2480:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    2483:	75 1b                	jne    24a0 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    2485:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2488:	89 04 24             	mov    %eax,(%esp)
    248b:	e8 ed fe ff ff       	call   237d <morecore>
    2490:	89 45 f4             	mov    %eax,-0xc(%ebp)
    2493:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2497:	75 07                	jne    24a0 <malloc+0xcb>
        return 0;
    2499:	b8 00 00 00 00       	mov    $0x0,%eax
    249e:	eb 13                	jmp    24b3 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    24a3:	89 45 f0             	mov    %eax,-0x10(%ebp)
    24a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    24a9:	8b 00                	mov    (%eax),%eax
    24ab:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    24ae:	e9 70 ff ff ff       	jmp    2423 <malloc+0x4e>
}
    24b3:	c9                   	leave  
    24b4:	c3                   	ret    
