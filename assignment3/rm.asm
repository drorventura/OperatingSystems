...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1066:	c7 44 24 04 5f 18 00 	movl   $0x185f,0x4(%esp)
    106d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1418:	0f b6 80 c4 2a 00 00 	movzbl 0x2ac4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1575:	75 09                	jne    1580 <printf+0x101>
          s = "(null)";
    1577:	c7 45 f4 78 18 00 00 	movl   $0x1878,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1641:	a1 e0 2a 00 00       	mov    0x2ae0,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    170c:	a3 e0 2a 00 00       	mov    %eax,0x2ae0
}
    1711:	c9                   	leave  
    1712:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    1764:	a1 e0 2a 00 00       	mov    0x2ae0,%eax
}
    1769:	c9                   	leave  
    176a:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1780:	a1 e0 2a 00 00       	mov    0x2ae0,%eax
    1785:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1788:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    178c:	75 23                	jne    17b1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    178e:	c7 45 f0 d8 2a 00 00 	movl   $0x2ad8,-0x10(%ebp)
    1795:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1798:	a3 e0 2a 00 00       	mov    %eax,0x2ae0
    179d:	a1 e0 2a 00 00       	mov    0x2ae0,%eax
    17a2:	a3 d8 2a 00 00       	mov    %eax,0x2ad8
    base.s.size = 0;
    17a7:	c7 05 dc 2a 00 00 00 	movl   $0x0,0x2adc
    17ae:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1804:	a3 e0 2a 00 00       	mov    %eax,0x2ae0
      return (void*)(p + 1);
    ...
    if(p == freep)
    1811:	a1 e0 2a 00 00       	mov    0x2ae0,%eax
